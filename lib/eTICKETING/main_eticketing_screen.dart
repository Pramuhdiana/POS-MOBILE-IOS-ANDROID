...
class MainEticketingScreen extends StatefulWidget {
  const MainEticketingScreen({Key? key}) : super(key: key);

  @override
  _MainEticketingScreenState createState() => _MainEticketingScreenState();
}
