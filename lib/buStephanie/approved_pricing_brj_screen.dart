                    ...
                    Expanded(
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            print('$limit == ${snapshot.data!.length}');

                            return NotificationListener<ScrollNotification>(
                                onNotification:
                                    (ScrollNotification scrollInfo) {
                                  // Cek jika pengguna mencapai akhir daftar
                                  ...
                                  if (scrollInfo.metrics.maxScrollExtent ==
                                    ...
                                    setState(() {
                                      limit += 15;
                                      if (limit > snapshot.data!.length) {
                                        print('limit menjadi total data');
                                        setState(() {
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      //   print('loading karena sudah akhir');
                                      //   setState(() {
                                      //     limit = snapshot.data!.length;
                                      //   });
                                      // }
