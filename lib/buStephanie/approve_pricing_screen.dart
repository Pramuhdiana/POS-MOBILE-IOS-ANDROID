...
class ApprovePricingScreen extends StatefulWidget {
  @override
  State<ApprovePricingScreen> createState() => _SearchScreenState();
}

class _SearchScreenState extends State<ApprovePricingScreen> {
  String searchInput = '';
  ...
  Future<List<ApprovePricingModel>> fetchData() async {
    ...
    var url = Uri.parse('http://192.168.22.163:4000/approvals/GetAll');
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ApiConstants.baseUrlPricing + ApiConstants.GETapprovelPricing));
            ...
            if (snapshot.hasData) {
              return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    var awalPrice = data.finalPrice3USD!;
                    return SizedBox(
                      height: 150,
                      child: Card(
                        child: Row(
