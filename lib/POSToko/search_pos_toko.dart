...
class SearchPosToko extends StatefulWidget {
  // Items? model;
  ModelAllitemsToko? model;
  // final Items? items;
  BuildContext? context;

  SearchPosToko({super.key, this.model, this.context});

  @override
  State<SearchPosToko> createState() => _SearchPosToko();
  // const SearchPosToko({required this.model});
}

class _SearchPosToko extends State<SearchPosToko> {
  var isLoading = false;
  int num = 0;
                        ...
                        IconButton(
                          onPressed: () async {
                            ...
                            if (existingitemcart == null) {
                              ...
                              setState(() {
                                postAPIcart();
                                DbAllitemsToko.db.updateAllitemsTokoByname(
                                    widget.model?.name, 0);
                              });
                            } else {
                              Fluttertoast.showToast(
