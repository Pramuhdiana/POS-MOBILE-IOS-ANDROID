...
class CartEventScreen extends StatefulWidget {
  const CartEventScreen({super.key});

  @override
  State<CartEventScreen> createState() => _CartEventScreenState();
}

class _CartEventScreenState extends State<CartEventScreen> {
  ModelAllitems? model;
