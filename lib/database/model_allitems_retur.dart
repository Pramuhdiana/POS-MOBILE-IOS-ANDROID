...
List<ModelAllitemsRetur> allitemsRetur(String str) =>
    List<ModelAllitemsRetur>.from(
        json.decode(str).map((x) => ModelAllitemsRetur.fromJson(x)));

String allitemsReturToJson(List<ModelAllitemsRetur> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelAllitemsRetur {
  int? id;
  String? name;
  String? slug;
  String? image_name;
  ...
  factory ModelAllitemsRetur.fromJson(Map<String, dynamic> json) =>
      ModelAllitemsRetur(
        id: json["id"] ?? 0,
        name: json["name"],
        slug: json["slug"],
