...
class AddCustomerMetierScreen extends StatefulWidget {
  @override
  State<AddCustomerMetierScreen> createState() =>
      _AddCustomerMetierScreenState();
}

class _AddCustomerMetierScreenState extends State<AddCustomerMetierScreen> {
